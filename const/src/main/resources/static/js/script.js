document.addEventListener('DOMContentLoaded', function() {
    ...
    function changeTestimonial() {
        if (document.querySelector('.testimonial')) {
            ...
            setTimeout(() => {
                ...
                testimonialEl.querySelector('.testimonial-text').textContent = testimonial.text;
                testimonialEl.querySelector('.author-img').src = testimonial.image;
                testimonialEl.querySelector('.author-name').textContent = testimonial.name;
                testimonialEl.querySelector('.author-role').textContent = testimonial.role;
    ...
    if (document.getElementById('map')) {
        ...
        L.marker([-19.9227, -43.9911], { icon: restaurantIcon })
            .addTo(map)
            .bindPopup(`
    ...
    const chatbot = {
        ...
        setupEventListeners() {
            this.elements.trigger.addEventListener('click', () => this.toggleChatbot());
            this.elements.closeBtn.addEventListener('click', () => this.hideChatbot());
        ...
        toggleChatbot() {
            ...
            document.querySelector('.back-to-top').style.visibility = 
        ...
        showWelcomeMessage() {
            setTimeout(() => {
                this.addMessage("Olá! Sou o assistente virtual do Apetito. Posso ajudar com informações sobre cardápio, horários e reservas. Como posso ajudar?", 'bot');
            }, 1000);
        },
        ...
        generateResponse(userInput) {
            ...
            else if (lowerInput.includes('reserva') || lowerInput.includes('mesa')) {
